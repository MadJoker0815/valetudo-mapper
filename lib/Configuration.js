...
const Configuration = function(options) {
    ...
    if (fs.existsSync(this.location)) {
        ...
        try {
            const parsedConfig = JSON.parse(fs.readFileSync(this.location));
            this.settings = Object.assign(this.settings, parsedConfig);
            ...
            if (JSON.stringify(parsedConfig) !== JSON.stringify(this.settings)) {
                this.persist();
            }
        } catch(e) {
            console.error(e);
